  ...
  return (
    <Flex className={' mt-16 justify-center lg:justify-between items-center gap-y-5 lg:gap-y-0'}>
        <div className="text-center lg:text-left lg:w-[50%]">
            ...
            <Flex className={'justify-center lg:justify-normal'}>
                <div>
                    <input type="text" className=" py-4 px-5 lg:w-[460px] border-none outline-none bg-white text-pColor" placeholder="search domain"/>
                </div>
                <Nbtn className={' py-4 px-9 bg-sColor text-white font-medium'}>Search</Nbtn>
            </Flex>
        </div>
        <Flex className={'lg:w-[30%] justify-center lg:justify-between items-center gap-y-5'}>
          <div className="w-[30%]">
